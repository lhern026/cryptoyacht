  ...
  const openWindow = () => {
    if (
      ...
      if (
        ...
        window.open(
          "https://metamask.app.link/dapp/cryptoyacht.vercel.app/mint/"
        );
  ...
  return (
    <>
      <s.Screen>
        <Menu stack>
          <Link to="/">
            <img src={"/config/images/logo.png"} width="95" height={35}></img>
          </Link>
          ...
          <a href="#whitepaper" className="menu-item">
            Whitepaper
          </a>
          <a href="https://discord.com/" target="_blank">
            <img
              src="https://i.pinimg.com/564x/cf/64/fc/cf64fcce5cc8296544516488631ad676.jpg"
              width="35"
              height="35"
            ></img>
          </a>
          <a href="https://www.instagram.com/?hl=en" target="_blank">
            <img
              src="https://i.pinimg.com/originals/36/77/7f/36777f93ecf8062a887a748c3dfeac31.jpg"
              width="45"
              height="45"
            ></img>
          </a>
        ...
        <AnimationOnScroll animateIn="animate__lightSpeedInLeft">
          <Link to="/mint">
            <button className="buttons calltoo ">
        ...
        <div className="about">
          <button className="buttons">
            <span>CRYPTO</span> <span class="emphasis">YACHT CLUB</span>
          </button>
          ...
          <div className="aboutcont">
            <p className="aboutText">
              ...
              laboriosam rerum ratione praesentium quia iusto dolore est
              asperiores quasi aliquam?{" "}
            </p>
          </div>
        </div>
        <div>
          <button className="buttons">
            {" "}
            <span class="emphasis">ROAD MAP</span>
          </button>
          <a name="roadmap"></a>
          <div class="timeline">
        ...
        <div className="faq">
          ...
          <button className="buttons">
            {" "}
            <span class="emphasis">F.A.Q</span>
          </button>
          <div class="box-content-colapse">
            ...
            <details class="details-comp">
              ...
              <p>
                ...
                ullam excepturi itaque impedit quos. Expedita quis commodi
                tempore, quam laboriosam rerum ratione praesentium quia iusto
                dolore est asperiores quasi aliquam?
              </p>
            </details>
            <details class="details-comp">
              <summary class="summary-colapse">
        ...
        <button className="buttons">
          <span class="emphasis">WHITEPAPER</span>
        </button>
